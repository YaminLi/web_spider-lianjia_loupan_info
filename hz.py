	...
	try:
		...
		for i in range(pageNum):
			if i==0:
				...
				html_tmp = ''
				req = urllib.request.Request(url+'pg'+str(i+1), headers=hds[random.randint(0,len(hds)-1)])
